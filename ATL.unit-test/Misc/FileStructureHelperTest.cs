    ...
    public class FileStructureHelperTest
    {
        ...
        public void FSH_Edit()
        {
            ...
            using (BinaryReader r = new BinaryReader(s))
            {
                ...
                structureHelper.RewriteHeaders(w.BaseStream, null, -2, FileStructureHelper.ACTION.Edit, "zone1");
                ...
                structureHelper.RewriteHeaders(w.BaseStream, null, -2, FileStructureHelper.ACTION.Edit, "zone2");
        ...
        public void FSH_Remove()
        {
            ...
            using (BinaryReader r = new BinaryReader(s))
            {
                ...
                structureHelper.RewriteHeaders(w.BaseStream, null, -5, FileStructureHelper.ACTION.Delete, "zone1");
        ...
        public void FSH_Add()
        {
            ...
            using (BinaryReader r = new BinaryReader(s))
            {
                ...
                structureHelper.RewriteHeaders(w.BaseStream, null, 5, FileStructureHelper.ACTION.Add, "zone3");
