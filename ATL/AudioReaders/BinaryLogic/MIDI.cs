    ...
    class TMidi : AudioDataReader, IMetaDataReader
    {
		...
		****************************************************************************/
        ...
        public override bool Read(BinaryReader source, StreamUtils.StreamHandlerDelegate pictureStreamHandler)
        {
            ...
            this.timebase = (header[8] << 8) + header[9];
            ...
            if (FComment.Length > 0) FComment.Remove(FComment.Length - 1, 1);
        ...
        ****************************************************************************/
        ...
        private MidiTrack _parseTrack(byte[] data, int tn)
        {
            ...
            {
                // timedelta
                currentDelta = _readVarLen(ref data, ref position);
                            ...
                            case 0xFF: // Meta
                                ...
                                switch (meta)
                                {
                                    ...
                                    case MidiEvents.META_CUE: // Meta Cue
                                        ...
                                        position += 2;
                                        len = _readVarLen(ref data, ref position);
